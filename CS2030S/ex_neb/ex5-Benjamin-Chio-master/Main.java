...
class Main {
  ...
  */
  ...
  public static String getGrade(
    ...
    Transformer<Student, Maybe<Course>> getCourse = std -> Maybe.of(std.getCourse(courseName));

    Transformer<Course, Maybe<Assessment>> getAssessment = cse -> Maybe.of(cse.getAssessment(assessmentName));

    Transformer<Assessment, Maybe<String>> getGrade = ass -> Maybe.of(ass.getGrade());
